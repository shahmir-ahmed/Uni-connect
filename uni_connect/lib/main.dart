...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      // Handle foreground messages (handles even background also)
  ...
  // when app in background or terminated handler (not handled by the app notification are still being recieved in all cases)
