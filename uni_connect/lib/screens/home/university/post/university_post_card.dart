            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  // uni name text
                  Text('${widget.uniName!.substring(0, 30)}...'),
                ],
              ),
            ...
            children: [
              ...
              Expanded(
                ...
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => CommentsScreen(commentDocId: widget.post.postId, uniProfileDocId: widget.uniProfileDocId,)),
                  );
                },
                icon: Icon(
